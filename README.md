...
> *Focus: IoT Communication, Data Visualization, Embedded Integration.*

#### 🌐 PHPWeb
A modular PHP MVC web application with database interaction using PDO and dynamic routing.  
> *Focus: Backend structure, clean architecture, and lightweight PHP design.*

#### ⚙️ Simple Fending Machine (C)
Simulation of a vending machine using C language with menu control, balance management, and product selection.  
> *Focus: Logic structuring and procedural programming.*
...
- Advanced **Laravel** features for scalable web systems  
- **Python programming** and **data processing**  
- Integration between **hardware interfaces** and **web backends**

---

### 🌐 Connect with Me
Feel free to reach out or collaborate on projects — I enjoy learning through building things together!  
...
[![Email](https://img.shields.io/badge/Email-berilfikri%40gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:berilfikri9@gmail.com)
